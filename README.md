...
To update the database use this command from the Web project folder (replace `CSA.Secretary` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../CSA.Secretary.Infrastructure/CSA.Secretary.Infrastructure.csproj -s CSA.Secretary.Web.csproj
```
